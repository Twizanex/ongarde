<?php 
	...
	'widget_manager:widgets:your_network:welcome' => "Welcome, %s",
	'widget_manager:widgets:your_network:edit' => "Edit",
	'widget_manager:widgets:your_network:dashboard' => "Dashboard",
	'widget_manager:widgets:your_network:settings' => "Settings",
	'widget_manager:widgets:your_network:colleagues' => "Colleagues",
	'widget_manager:widgets:your_network:myfiles' => "My Files",
	'widget_manager:widgets:your_network:mygroups' => "My Groups",
	'widget_manager:widgets:your_network:mybookmarks' => "My Bookmarks",
	'widget_manager:widgets:your_network:groupinvites' => "Group Invites",
	'widget_manager:widgets:your_network:myquestions' => "My Questions",
	'widget_manager:widgets:your_network:forums' => "Unread Forums",
	'widget_manager:widgets:your_network:mylearning' => "My Learning",
	'widget_manager:widgets:your_network:tooltipTitle' => "Your Network",
	'widget_manager:widgets:your_network:tooltip' => "This is your quick access area. It provides customization tools for your profile, as well as links to frequently visited pages.",

	'widget_manager:widgets:getting_started:ineed' => "I want to:",
	'widget_manager:widgets:getting_started:find' => "Find",
	'widget_manager:widgets:getting_started:create' => "Create",
	'widget_manager:widgets:getting_started:share' => "Share",
	'widget_manager:widgets:getting_started:search' => "Search",
	'widget_manager:widgets:getting_started:members' => "Members",
	'widget_manager:widgets:getting_started:forums' => "Forums",
	'widget_manager:widgets:getting_started:event' => "Event",
	'widget_manager:widgets:getting_started:group' => "Group",
	'widget_manager:widgets:getting_started:project' => "Project",
  	'widget_manager:widgets:getting_started:page' => "Page",
  	'widget_manager:widgets:getting_started:questionBtn' => "Question",
  	'widget_manager:widgets:getting_started:task' => "Task",
  	'widget_manager:widgets:getting_started:bookmarkBtn' => "Bookmark",
  	'widget_manager:widgets:getting_started:file' => "File",
  	'widget_manager:widgets:getting_started:status' => "Status",
   	'widget_manager:widgets:getting_started:video' => "Video",
	'widget_manager:widgets:getting_started:tooltipTitle' => "Content Wizard",
	'widget_manager:widgets:getting_started:tooltip' => "Enter a search term. Reminder: Uncheck those items that do not pertain to your search. Click “Create” or “Share” to view a list of items that you can create or share respectively.",

	'widget_manager:widgets:my_resources:myresources' => "My Resources",
	'widget_manager:widgets:my_resources:filterBy' => "Role:",
	'widget_manager:widgets:my_resources:learner' => "Learner",
	'widget_manager:widgets:my_resources:developer' => "Developer",
	'widget_manager:widgets:my_resources:instructor' => "Instructor",
	'widget_manager:widgets:my_resources:trainingmgr' => "Training Mgr",
	'widget_manager:widgets:my_resources:tooltipTitle' => "Access Resources by Role",
	'widget_manager:widgets:my_resources:tooltip' => "Get access to several CAF resources from this location. Are you a Learner? Developer? Instructor? Filter resources specifically to your role using the drop down menu.",

	'widget_manager:widgets:index_activity:activityfeed' => "Activity Feed",
	'widget_manager:widgets:index_activity:all' => "All",
	'widget_manager:widgets:index_activity:colleagues' => "Colleagues",
	'widget_manager:widgets:index_activity:learners' => "Learners",
	'widget_manager:widgets:index_activity:developers' => "Developers",
	'widget_manager:widgets:index_activity:instructors' => "Instructors",
	'widget_manager:widgets:index_activity:toolTipLearner' => "Tag your content “Learner” to show up in this feed",
	'widget_manager:widgets:index_activity:toolTipDeveloper' => "Tag your content “Developer” to show up in this feed",
	'widget_manager:widgets:index_activity:toolTipInstructor' => "Tag your content “Instructor” to show up in this feed",
	'widget_manager:widgets:index_activity:tooltipTitle' =>  "Filtering the Activity Feed",
	'widget_manager:widgets:index_activity:tooltip' => "This area lists the most recent activity on the Learning Portal. Filter the activity feed by selecting the tabs along the top.",

	'widget_manager:widgets:index_groups:tooltipTitle' => "List of Your Groups",
	'widget_manager:widgets:index_groups:tooltip' => "Quickly get access to your groups with one click from this area.",

	'widget_manager:widgets:next' => "Next",
	'widget_manager:widgets:prev' => "Previous",
	'widget_manager:widgets:close' => "Close",
	...
	'settings:user' => 'Account Settings',
		...
		'widget_manager:widgets:index_login:welcome' => "Welcome <b>%s</b>! Get started today.",
